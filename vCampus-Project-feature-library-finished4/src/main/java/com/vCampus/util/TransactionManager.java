...
public class TransactionManager {
    ...
    public static void runLaterSafe(Runnable runnable) {
        try {
            ...
            java.lang.reflect.Method isFxApplicationThreadMethod = platformClass.getMethod("isFxApplicationThread");
            java.lang.reflect.Method runLaterMethod = platformClass.getMethod("runLater", Runnable.class);
            
            boolean isFxThread = (Boolean) isFxApplicationThreadMethod.invoke(null);
            if (isFxThread) {
                runnable.run();
            } else {
